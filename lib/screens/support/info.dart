      ...
      child: Column(
        children: [
          Container(
            alignment: Alignment.centerLeft,
            width: MediaQuery.of(context).size.width,
            child: MyWidgets.text(titles[issue-1], 19, FontWeight.bold, const Color(0xff3B4652),context,false),
          ),
          ...
          TextButton(
            onPressed: (){
              MyWidgets.navigateP(const SomethingElse(), context);
            },
            child: Text(
              "I still need help",
              style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const SizedBox(height: 20,),
          Container(padding:const EdgeInsets.all(10),alignment:Alignment.centerLeft,child: MyWidgets.text("Select an Issue", 17.0, FontWeight.bold, const Color(0xff3B4652),context,false)),
          SearchChoices.single(
            items: [
              DropdownMenuItem(
                value: 1,
                child: MyWidgets.text("Transfer hasn't arrived yet", 18.0, FontWeight.normal, const Color(0xff3B4652),context,false),
              ),
              DropdownMenuItem(
                value: 2,
                child: MyWidgets.text("I sent the money to the wrong bank details", 18.0, FontWeight.normal, const Color(0xff3B4652),context,false),
              ),
              DropdownMenuItem(
                value: 3,
                child: MyWidgets.text("I want to cancel this transfer", 18.0, FontWeight.normal, const Color(0xff3B4652),context,false),
              ),
              DropdownMenuItem(
                value: 4,
                child: MyWidgets.text("Something else", 18.0, FontWeight.normal, const Color(0xff3B4652),context,false),
              ),
            ],
            onChanged: (value) {
              setState(() {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              alignment: Alignment.centerLeft,
              child: MyWidgets.text("Tell us more", 21, FontWeight.bold, const Color(0xff3B4652),context,false),
            ),
            const SizedBox(height: 20,),
            Container(
              width: MediaQuery.of(context).size.width * 0.9,
            ...
            Container(
              width: MediaQuery.of(context).size.width * 0.9,
              alignment: Alignment.centerLeft,
              child: MyWidgets.text("Give as much detail as you can", 16, FontWeight.normal, const Color(0xff3B4652),context,false),
            ),
            const SizedBox(height: 10,),
            Container(
              decoration: BoxDecoration(
