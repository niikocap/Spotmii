...
class _ConvertMoneyState extends State<ConvertMoney> {
  ...
  var cur1 = "PHP ${currentUser!.php}";
  var cur2 = "C¥ ${currentUser!.cny}";
        ...
        child: FractionallySizedBox(
          ...
          child: Column(
            children: [
              ...
              Column(
                children: [
                  Container(width:MediaQuery.of(context).size.width * 0.8,alignment:Alignment.centerLeft,child: MyWidgets.text("Value to Convert:", 16.0, FontWeight.bold, const Color(0xff3B4652), context,false)),
              ...
              Column(
                children: [
                  Container(width:MediaQuery.of(context).size.width * 0.8,alignment:Alignment.centerLeft,child: MyWidgets.text("From:", 16.0, FontWeight.bold, const Color(0xff3B4652), context,false)),
                  const SizedBox(height: 10,),
                  Container(
                      width:MediaQuery.of(context).size.width * 0.80,
                      height: 50,
                            ...
                            child: DropdownButton<String>(
                                ...
                                onChanged: (value) async{
                                  ...
                                  if(value == 'PHP'){
                                    ...
                                    cur1 = "${value!} ${currentUser!.php}";
                                  }else if(value == '\$'){
                                    currency1 = "US Dollar";
                                    cur1 = "${value!} ${currentUser!.usd}";
                                  }else if(value == '€'){
                                    currency1 = "Euro";
                                    cur1 = "${value!} ${currentUser!.eur}";
                                  }else if(value == '£'){
                                    currency1 = "Pound";
                                    cur1 = "${value!} ${currentUser!.gbp}";
                                  }else if(value == 'A\$'){
                                    currency1 = "Australian Dollar";
                                    cur1 = "${value!} ${currentUser!.aud}";
                                  }else if(value == 'Fr'){
                                    currency1 = "Swiss Franc";
                                    cur1 = "${value!} ${currentUser!.chf}";
                                  }else if(value == 'C¥'){
                                    currency1 = "Chinese Yuan";
                                    cur1 = "${value!} ${currentUser!.cny}";
                                  }else if(value == '¥'){
                                    currency1 = "Japanese Yen";
                                    cur1 = "${value!} ${currentUser!.jpy}";
                                  }
                                  ...
                                  setState(() {
                                    result = "${amountController.text} $currency1 = $converted $currency2";
                                  });
                                }
                            ),
                          ),
                          MyWidgets.text(currency1, 18.0, FontWeight.bold, const Color(0xff04123B), context,false)
                        ],
                      )
                  )
                ],
              ...
              Column(
                children: [
                  Container(width:MediaQuery.of(context).size.width * 0.8,alignment:Alignment.centerLeft,child: MyWidgets.text("To:", 16.0, FontWeight.bold, const Color(0xff3B4652), context,false)),
                  const SizedBox(height: 10,),
                  Container(
                      width:MediaQuery.of(context).size.width * 0.80,
                      height: 50,
                      ...
                      child: Row(
                        children: [
                          ...
                          MyWidgets.text(currency2, 18.0, FontWeight.bold, const Color(0xff04123B), context,false)
                        ],
                      )
                  )
                ],
              ...
              Column(
                children: [
                  Container(width:MediaQuery.of(context).size.width * 0.8,alignment:Alignment.centerLeft,child: MyWidgets.text("Result:", 16.0, FontWeight.bold, const Color(0xff3B4652), context,false)),
                  const SizedBox(height: 10,),
                  Container(
                    width:MediaQuery.of(context).size.width * 0.80,
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 10,),
                              MyWidgets.text(response == "\"success\"" ?  "Success" : response, 25, FontWeight.bold, const Color(0xff111111), context, false),
                              const SizedBox(height: 10,),
