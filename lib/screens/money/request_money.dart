          ...
          children: [
            ...
            Column(
              children: [
                ...
                Visibility(visible:false,child: Container(width: MediaQuery.of(context).size.width * 0.9,padding:const EdgeInsets.all(10),alignment:Alignment.centerLeft,child: MyWidgets.text("Request Again", 20.0, FontWeight.bold, const Color(0xff1B1B1B),context,false))),
                Visibility(
                  visible: true,
                  child: FutureBuilder(
            ...
            TextButton(
                ...
                child: MyWidgets.text("Request Money via QR Code", 16.0, FontWeight.bold, const Color(0xff1B1B1B),context,false)
            )
